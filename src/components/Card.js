    ...
    <CardContainer onMouseEnter={()=>setOnHovered(true)} onMouseLeave={()=>setOnHovered(false)}>
      <img src={`https://image.tmdb.org/t/p/w500${movieData.image}`} alt="movie poster" onClick={()=>navigate('/player')}/>
      {
        onHovered &&
          ...
          <img src={`https://image.tmdb.org/t/p/w500${movieData.image}`} alt="movie poster" onClick={()=>navigate("/player")}/>
          <video src="https://res.cloudinary.com/de9qmxjzn/video/upload/v1693860403/Ver_The_End_of_the_Tour_2015_Online_Latino_HD_-_Pelisplus_-_Google_Chrome_2023-07-08_16-09-02_rujy0e.mp4" autoPlay loop controls/>
